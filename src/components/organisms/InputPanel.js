      ...
      <div className="input-panel-wrapper">
        <div className="input-panel-container">
          <div className="input-panel-text">
            ...
            <h3 className="input-panel-text__description">Sauce Orchestrate tests are kicked off via CLI utility <a target="_blank" href="https://docs.saucelabs.com/dev/cli/saucectl/" rel="noreferrer">saucectl</a>. saucectl commands can be run manually or part of your CI/CD, and references a <a target="_blank" href="https://docs.saucelabs.com/orchestrate/saucectl-configuration/" rel="noreferrer">YAML file</a> in your repo which instructs the utility how to run your tests. Use this YAML generator to create a custom YAML for your test suite.</h3>
          </div>
        </div>
      </div>
    );
